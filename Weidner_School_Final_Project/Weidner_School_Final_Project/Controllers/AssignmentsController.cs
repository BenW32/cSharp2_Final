...
namespace Weidner_School_Final_Project.Controllers
{
    ...
    public class AssignmentsController : ControllerBase
    {
        ...
        public AssignmentsController(JwtAuthenticationManager jwtAuthenticationManager, Weidner_SchoolContext context)
        {
            this.jwtAuthenticationManager = jwtAuthenticationManager;
            _context = context;
        }
        //-------------------------
        /* public AssignmentsController(Weidner_SchoolContext context)
         {
             _context = context;
         }*/
        ...
        public async Task<ActionResult<Assignment>> PostAssignment(Assignment assignment)
        {
          if (_context.Assignments == null)
          {
              return Problem("Entity set 'Weidner_SchoolContext.Assignments'  is null.");
          }
